...
class TestIntegration(unittest.TestCase):
    ...
    def test_patch(self):
        self.maxDiff = None
        header, name, components, aliases = json2daisy.generate_header_from_name('patch')
    ...
    def test_patch_init(self):
        self.maxDiff = None
        header, name, components, aliases = json2daisy.generate_header_from_name('patch_init')
    ...
    def test_petal(self):
        self.maxDiff = None
        header, name, components, aliases = json2daisy.generate_header_from_name('petal')
    ...
    def test_field(self):
        self.maxDiff = None
        header, name, components, aliases = json2daisy.generate_header_from_name('field')
